...
n_squares_in_visualization_sets = [9, None]  # choose how many squares are in the displays. if None, all stimuli will be present
...
for n_squares_in_visualization_set in n_squares_in_visualization_sets:

    vis_path = res_path + '/visualizations_' + str(n_squares_in_visualization_set)
    npy_dataset_path_visualization = './dataset_visualization_imsz_' + str(im_size[0]) + str(im_size[1]) + '_' + str(
        n_squares_in_visualization_set) + '.npy'
    npy_matrices_path_visualization = './dataset_matrices_imsz_' + str(im_size[0]) + str(im_size[1]) + '_' + str(
        n_squares_in_visualization_set) + '.npy'
    ...
    for model_type in models:
        ...
        for latent_dim in chosen_n_units:
            ...
            if 'alexnet' or '16_dims' in model_type:
                ...
                adjacent_squares_losses(dataset_visualization[:1500], matrices[:1500], model, save_path=save_path)
