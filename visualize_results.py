...
vis_path = res_path + '/visualizations'
...
for model_type in models:
    ...
    # make_gif_from_frames(dataset_visualization, im_size, model, model_type, chosen_n_units, type='configs_and_loss_curves', save_path=save_path)
